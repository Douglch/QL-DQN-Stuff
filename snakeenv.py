...
class SnekEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.observation_space = spaces.Box(low=-500, high=500,
                                            # 5 for the number of attributes in the observation space
    ...
    def step(self, action):
        ...
        self.prev_reward = self.total_reward  # Apples eaten
        ...
        self.observation = [head_x, head_y, apple_delta_x,
                            apple_delta_y, snake_length] + list(self.prev_actions)  # list() converts deque to a list
        self.observation = np.array(self.observation, dtype=np.float32)

        info = {}
        return self.observation, self.reward, self.terminated, info

    # You can also think of reset() as the initialization method.
